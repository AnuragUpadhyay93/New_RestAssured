...
public class CreateNotesResult {
	String outh_token;
	String notes_id;
	String rand_title;
	WebDriver driver;
	...
	public void startReport() {
		...
		extent.setSystemInfo("QA Name", "Anurag");
	...
	public void getToken() {
		...
		outh_token = BaseClass.GetToken("anurag@xyz.com", "1234567890");
	...
	public void createNotes() throws IOException, ParseException {
		...
		request.body(BaseClass.readFile("Create_Notes.json").toJSONString());
		// POST the Response
